...
export default function PaymentForm({ handlePaymentFormChange,paymentFormData }) {
  ...
  const handleCardNumberChange = (event) => {
    ...
    if (value.length <= 16) {
      ...
      handlePaymentFormChange('cardNumber', formattedValue);
    }
  };
  ...
  const handleExpirationDateChange = (event) => {
    ...
    if (value.length <= 4) {
      ...
      handlePaymentFormChange('expirationDate', formattedValue);
    }
  };
